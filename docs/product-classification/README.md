...
itnew/
├── app.py
├── dashboards/product/         # 품목 분석 Streamlit 화면
├── services/product/           # 분류·분석 서비스
├── data/
│   ├── input/orders.csv        # 주문 원본 데이터
│   └── output/                 # 분석 결과 (gitignore)
│   ├── product_classification.csv
│   ├── product_demand_analysis.csv
│   └── category_summary.csv
└── docs/product-classification/
```
...
| `dashboards/product/` | Streamlit 품목분석 화면 |
